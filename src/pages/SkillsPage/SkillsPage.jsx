...
function SkillsPage() {
  ...
  return (
    <>
      <SEO
        title="Skills | Mohit Raghav"
        description="Explore the technical skills of Mohit Raghav, including React, JavaScript, Node.js, Next.js, MongoDB, Python, and other web development technologies."
        path="/skills"
      />
