...
function HomePage() {
  ...
  return (
    <>
      <SEO
        title="Mohit Raghav | Full Stack Developer & AI/ML Engineer"
        description="Portfolio of Mohit Raghav, a Full Stack Developer specializing in React, Node.js, Next.js, MERN, and AI/ML."
        path="/"
      />
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <section className={styles.hero}>
          ...
          >
            ...
            <motion.h1 className={styles.name} variants={childVariants}>
              Mohit Raghav — Full Stack Developer
            </motion.h1>
